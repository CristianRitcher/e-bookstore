    ...
    <div id="wrapper">
      <div id="signup">
        ...
        <div class="formfield"><br>
          <label for="name">User Name <span style="color: red;"><sup>*</sup></span></label>
        </div><br>
        <input type="text" name="cus_name" id="cus_name" value="<?php echo $val['cus_name']; ?>" onkeyup="userCheck(); disfunc();" required>

        <div class="formfield"><br>
          <label for="name">Email <span style="color: red;"><sup>*</sup></span></label>
        </div><br>
        ...
        <div class="formfield"><br>
          ...
          <input type="file" id='profilepic' placeholder="image" name="cus_img" accept="image/*" style="margin-top:15px; display: inline">
        </div><br>
